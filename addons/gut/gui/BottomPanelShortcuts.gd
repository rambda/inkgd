...
@onready var _ctrls = {
	run_all = $PanelContainer/Layout/CRunAll/ShortcutButton,
	run_current_script = $PanelContainer/Layout/CRunCurrentScript/ShortcutButton,
	run_current_inner = $PanelContainer/Layout/CRunCurrentInner/ShortcutButton,
	run_current_test = $PanelContainer/Layout/CRunCurrentTest/ShortcutButton,
	panel_button = $PanelContainer/Layout/CPanelButton/ShortcutButton,
}
