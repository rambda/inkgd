...
%TS%_ink_player.loaded.connect(self._story_loaded)
%TS%_ink_player.continued.connect(self._continued)
%TS%_ink_player.prompt_choices.connect(self._prompt_choices)
%TS%_ink_player.ended.connect(self._ended)
