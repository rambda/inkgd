...
func test_external_binding():
	print(get_node("/root/InkRuntime"))

	var story = InkStory.new(load_file("external_binding"))

	var _test_external_binding_message := ""

	story.bind_external_function("message", func(arg): _test_external_binding_message = "MESSAGE: " + arg)
	story.bind_external_function("multiply", func(arg1, arg2): return arg1 * arg2)
	story.bind_external_function("times", _external_binding_times)
...
func test_game_ink_back_and_forth():
	...
	_game_ink_back_and_forth_story.bind_external_function("gameInc", _game_ink_back_and_forth_game_inc, false)
...
func test_lookup_safe_or_not():
	...
	story.bind_external_function("myAction", _my_action_lookup_safe)
	...
	story.bind_external_function("myAction", _my_action_lookup_unsafe)

	story.continue_maximally()
	assert_eq(unsafe_call_count, 1)

	var story_with_post_glue = InkStory.new(load_file("lookup_safe_or_not_with_post_glue"))
	story_with_post_glue.bind_external_function("myAction", _my_action_lookup_safe_with_post_glue)
...
func test_variable_observer():
	...
	story.observe_variable("testVar", _variable_observer_test)
	story.continue_maximally()
